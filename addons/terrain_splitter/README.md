...
2) Move the addons/terrain_splitter folder into your Godot project's res://addons/ directory.

3) Open your Godot project and go to Project > Project Settings > Plugins.

4) Find Terrain Splitter in the list and check the Enable box.

🚀 How to Use

1) Select any MeshInstance3D node in your scene tree.

2) Look at the top of your 3D Viewport (next to the Translate/Rotate/Scale tools) and click the new Split Terrain button.

3) A menu will pop up. Enter the number of chunks you want for the X and Z axes.

4) Check Make static bodies if you want collision shapes generated for the chunks (highly recommended for walkable terrain).
